...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Model401 :  IEquatable<Model401>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Model401" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Model401" /> class.
        /// </summary>
        /// <param name="descripcion">descripcion (required) (default to &quot;Unauthorized&quot;).</param>
        /// <param name="estado">estado (required).</param>
        public Model401(string descripcion = "Unauthorized", int? estado = default(int?))
        {
            // to ensure "descripcion" is required (not null)
            if (descripcion == null)
            {
                throw new InvalidDataException("descripcion is a required property for Model401 and cannot be null");
            }
            else
            {
            ...
            if (estado == null)
            {
                throw new InvalidDataException("estado is a required property for Model401 and cannot be null");
            }
            else
            {
                this.Estado = estado;
        ...
        {
            return this.Equals(input as Model401);
        }

        /// <summary>
        /// Returns true if Model401 instances are equal
        /// </summary>
        /// <param name="input">Instance of Model401 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Model401 input)
        {
            if (input == null)
                return false;
